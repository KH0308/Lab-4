...
public class ClientLengthFrame extends JFrame
{
private static final long serialVersionUID = 1L;
	...
	public ClientLengthFrame () {
		...
		lblServerWord.setBounds(282, 38, 394, 39);
	 ...
	 */
	public void updateServerWord (String serverDate) {
		
		this.lblServerWord.setText(serverDate);
	...
	private JPanel getServerDatePanel(Font font) {
		...
		JPanel panel = new JPanel();
		JLabel lblWord = new JLabel ("Word (from Server): ");
		lblWord.setBounds(10, 38, 269, 39);
